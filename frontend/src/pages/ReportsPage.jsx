                  ...
                  <div>
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] bg-rose-50 text-rose-600 border border-rose-200 dark:bg-rose-950/20 dark:text-rose-450 dark:border-rose-900/30 px-2 py-0.5 rounded font-bold capitalize tracking-wider">
                          Admin/PM Exclusive
                        </span>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] bg-emerald-50 text-emerald-600 border border-emerald-200 dark:bg-emerald-950/20 dark:text-emerald-450 dark:border-emerald-900/30 px-2 py-0.5 rounded font-bold capitalize tracking-wider">
                          Client
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="bg-surface-container-low dark:bg-slate-750 rounded-lg p-4 mb-6 border border-outline-variant/30 dark:border-slate-700">
                      <div className="flex items-center gap-1.5 text-on-surface-variant dark:text-slate-400 mb-1">
                        ...
                        <span className="font-label-caps text-[10px] capitalize tracking-wider">Safety Protocol</span>
                      </div>
              ...
              <div className="bg-surface-container-lowest dark:bg-slate-800 rounded-xl border border-outline dark:border-slate-700 shadow-soft overflow-hidden mt-8">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-surface-container-low dark:bg-slate-900/60 font-label-caps text-[12px] text-on-surface-variant dark:text-slate-400 border-b border-outline dark:border-slate-700 capitalize tracking-wider">
                        ...
                        <tr key={idx} className="border-b border-outline/30 dark:border-slate-700/50 hover:bg-surface-container-low/30 dark:hover:bg-slate-900/30 transition-colors h-[64px]">
                          ...
                          <td className="py-3.5 px-4 sm:py-4 sm:px-6 text-on-surface-variant dark:text-slate-400 whitespace-nowrap">
                            <div className="flex flex-col">
                              ...
                              <span className="text-[10px] text-on-surface-variant/75 dark:text-slate-500 capitalize font-semibold">
