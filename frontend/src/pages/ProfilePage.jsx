  ...
  return (
    <div className="min-h-screen bg-slate-50/50 antialiased font-sans">
      <header className="h-16 bg-white border-b border-slate-200/80 sticky top-0 z-40 flex items-center px-6 sm:px-8 shadow-sm gap-4">
        ...
        <h1 className="font-extrabold text-slate-900 text-base tracking-tight">My Profile</h1>
      </header>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/70 shadow-sm p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            >
              {avatarPreview || user?.avatar ? (
                ...
                <div className="w-20 h-20 rounded-full bg-indigo-600 flex items-center justify-center text-white text-2xl font-bold ring-4 ring-indigo-100 shadow">
            ...
            <p className="text-xs text-slate-400 mt-2">Click avatar to change photo</p>
            <span className="mt-1 text-xs font-semibold text-indigo-600 bg-indigo-50 px-2.5 py-0.5 rounded-full border border-indigo-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2 border-t border-slate-100">
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1.5">New Password <span className="text-slate-300 lowercase font-normal">(leave blank to keep current)</span></label>
              <input
                type="password"
                value={password}
            ...
            {password && (
              <div>
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full h-11 px-3.5 rounded-xl border text-slate-800 text-sm font-medium placeholder-slate-400 focus:outline-none focus:ring-4 transition-all ${
                    confirmPassword && password !== confirmPassword
                      ? 'border-rose-400 bg-rose-50 focus:ring-rose-500/10'
