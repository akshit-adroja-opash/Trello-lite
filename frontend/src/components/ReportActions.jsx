        ...
        <div className="flex flex-col sm:flex-row gap-4">
            {canGenerateFull && (
                <button
                    ...
                    className="h-11 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-5 rounded-xl shadow-md transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
